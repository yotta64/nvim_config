...
require("lazy").setup({
            ...
            lualine_x = {
              ...
              end, 
              {
                function()
                  ...
                  if not ok then ok, gv = pcall(require, "config.ghostvault") end
...

    {
      ...
      opts = { render = "background" }, -- O "background"
    },
    -- Installazione (Lazy)
    {
        "uga-rosa/ccc.nvim",
		...
		},
    {
      ...
      config = function()
        require("project_nvim").setup({
          -- Rilevamento automatico della root
          detection_methods = { "pattern" },
          -- Quali file indicano che è un progetto?
          patterns = { ".git", "_darcs", ".hg", ".bzr", ".svn", "Makefile", "package.json", "go.mod" }, 
          -- Importante: cambia automaticamente la directory quando apri un file
          manual_mode = false,
        })
        -- Carica l'estensione di Telescope (se usi Telescope)
